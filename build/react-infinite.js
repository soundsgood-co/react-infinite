...
var Infinite = React.createClass({
  ...
  generateComputedUtilityFunctions: function generateComputedUtilityFunctions(props) {
    ...
    if (props.useWindowAsScrollContainer) {
      ...
      utilities.subscribeToScrollListener = function () {
        props.setScrollHandler(_this.infiniteHandleScroll);
      };
      utilities.unsubscribeFromScrollListener = function () {
        props.removeScrollHandler(_this.infiniteHandleScroll);
      };
      utilities.nodeScrollListener = function () {};
      utilities.getScrollTop = props.getScrollTop;
      utilities.setScrollTop = props.setScrollTop;
      utilities.scrollShouldBeIgnored = props.scrollShouldBeIgnored || function () {
        return false;
      };
      utilities.buildScrollableStyle = function () {
        return {};
      ...
      utilities.getScrollTop = function () {
        ...
        if (_this.getScrollable()) {
          scrollable = ReactDOM.findDOMNode(_this.getScrollable());
        }
      ...
      utilities.scrollShouldBeIgnored = function (event) {
        return event.target !== ReactDOM.findDOMNode(_this.getScrollable());
      };
